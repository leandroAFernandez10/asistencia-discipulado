...
CREATE TABLE discipulo (
  id_discipulo INT AUTO_INCREMENT PRIMARY KEY,
  nombre VARCHAR(50),
  apellido VARCHAR(50),
...
CREATE TABLE matriculacion (
  ...
  FOREIGN KEY (id_discipulo) REFERENCES discipulo(id_discipulo),
...
CREATE TABLE celula (
  ...
  estado ENUM('Activa', 'Inactiva'),
    FOREIGN KEY (id_disciplina) REFERENCES matriculacion(id_disciplina),
  FOREIGN KEY (timonel) REFERENCES discipulo(id_discipulo),
  FOREIGN KEY (anfitrion) REFERENCES discipulo(id_discipulo),
  FOREIGN KEY (colaborador) REFERENCES discipulo(id_discipulo)
);
